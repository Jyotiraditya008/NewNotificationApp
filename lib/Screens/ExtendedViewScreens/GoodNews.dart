          ...
          flexibleSpace: Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/newbackground/GoodNews.png'),
                fit: BoxFit.fill,
              ),
            ),
            child: SafeArea(
                    ...
                    return GestureDetector(
                      child: Material(
                        ...
                        child: Container(
                          ...
                          child: DottedBorder(
                            color: Color.fromARGB(255, 231, 249, 230),
                            strokeWidth: 1,
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...points.map(
                                    (point) => Container(
                                      color: Color.fromARGB(255, 238, 251, 238),
                                      child: ListTile(
