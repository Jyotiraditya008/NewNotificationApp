...
class ClubsDetailsScreen extends StatefulWidget {
  const ClubsDetailsScreen({super.key});

  @override
  State<ClubsDetailsScreen> createState() => _ClubsDetailsScreenState();
}

class _ClubsDetailsScreenState extends State<ClubsDetailsScreen> {
