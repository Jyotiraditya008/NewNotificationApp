...
import 'package:minervaschool/Screens/ExtendedViewScreens/GoodNews.dart';
import 'package:minervaschool/Screens/ExtendedViewScreens/Incident.dart';

class Conductandbehaviour extends StatelessWidget {
  final List<Map<String, dynamic>> buttonData = [
    {
      'text': 'Incident',
      'imagePath': 'assets/newIcons/Incident.png',
    },
    {
      'text': 'Good News',
      'imagePath': 'assets/newIcons/GoodNews.png',
    },
  ];
            ...
            children: List.generate(buttonData.length, (index) {
              return DottedBorder(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (buttonData[index]['text'] == 'Good News') {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GoodNews(),
                        ),
                      );
                    } else {
                      Navigator.push(
